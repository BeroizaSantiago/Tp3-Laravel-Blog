<footer class="bg-gray-800 !bg-opacity-100 text-black text-center py-6">
    <div class="flex justify-center gap-6 mb-4">
        <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-600">
        ...
        <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-600">
        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
            <path d="M17.1 3H21l-7.5 9.2L22 21h-4l-5.6-6.9L6.8 21H3l7.6-9.2L2 3h4l5.2 6.5L17.1 3Z"/>
        </svg>
        </a>

        <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" class="text-gray-500 hover:text-gray-600">
        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
